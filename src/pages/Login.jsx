              ...
              <div className="flex flex-col w-96 p-[28px]">
                <div className="flex items-center justify-center w-full">
                  ...
                  >
                    ...
                    <h1>
                      <span className="self-center text-3xl font-semibold text-transparent vertical-center hide-on-small-screen whitespace-nowrap darrk:text-white bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">
                        WorkBench System
                      </span>
                    </h1>
                  </a>
                  ...
                  <div className="p-6 gap-y-4 md:gap-y-6 sm:p-8">
                    ...
                    >
                      <div>
                        <label
                          htmlFor="loginEmail"
                          className="block mb-2 text-base font-medium text-gray-900 darrk:text-white"
                        >
                          Account
                        </label>
                        <input
                      ...
                      >
                        <div className="flex items-center h-5">
                          <input
                            ...
                            type="checkbox"
                            className="w-4 h-4 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-primary-300 darrk:bg-gray-700 darrk:border-gray-600 darrk:focus:ring-primary-600 darrk:ring-offset-gray-800"
                            required=""
                          />
                        </div>
                        <div className="mb-6 ml-3 text-sm">
                          <label
                            className="font-light text-gray-500 darrk:text-gray-300"
                            required
                          >
                      ...
                      <button
                        type="submit"
                        className="w-full  text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-base px-5 py-2.5 text-center darrk:bg-blue-600 darrk:hover:bg-blue-700 darrk:focus:ring-blue-800"
                      >
                        Log in
                      </button>
                    </form>
